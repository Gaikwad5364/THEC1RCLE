...
export default function HostCard({ host, onFollow, index }) {
    ...
    return (
        <motion.div
            ...
            className="group relative flex flex-col overflow-hidden rounded-[32px] border border-black/10 dark:border-white/10 bg-white dark:bg-[#121212] transition-all duration-500 hover:border-orange/40 hover:shadow-[0_0_40px_rgba(244,74,34,0.15)]"
        >
            {/* Always-on Aura Glow */}
            ...
            {/* Stats Row */}
            <div className="flex items-center justify-between p-6 border-b border-black/5 dark:border-white/5 bg-gray-50 dark:bg-black/20">
                <div className="flex flex-col">
                    <span className="text-sm font-black text-black dark:text-white">{host.followers.toLocaleString()}</span>
            ...
            <div className="p-4 flex items-center justify-between gap-4">
                <button
                    ...
                    className="flex-1 px-6 py-3 rounded-full bg-black dark:bg-white text-white dark:text-black text-[10px] font-bold uppercase tracking-widest transition-all hover:opacity-90 hover:scale-105 active:scale-95 shadow-lg flex items-center justify-center gap-2"
                >
                ...
                <div className="flex gap-2">
                    <button
                        className="flex h-11 w-11 items-center justify-center rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white hover:bg-black/10 dark:hover:bg-white/10 transition-all active:scale-90"
                        title="Share Profile"
                    >
                        <Share2 size={18} />
                    </button>
...
export function HostSkeleton() {
    return (
        <div className="flex flex-col overflow-hidden rounded-[32px] border border-black/10 dark:border-white/10 bg-white dark:bg-[#121212]">
