...
export default function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="relative flex h-9 w-16 items-center rounded-full bg-white/80 dark:bg-white/10 p-1 transition-colors hover:bg-white dark:hover:bg-white/20 border border-black/5 dark:border-white/10 shadow-sm backdrop-blur-md"
        ...
        >
            ...
            >
                {isDark ? (
                    ...
                    <SunIcon className="h-4 w-4 text-orange" />
                )}
            </motion.div>
        </button>
    );
