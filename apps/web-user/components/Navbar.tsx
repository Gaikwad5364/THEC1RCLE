    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="hidden items-center gap-1 lg:flex bg-white/80 dark:bg-white/5 rounded-full p-1 border border-black/5 dark:border-white/5 backdrop-blur-md shadow-sm">
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  href={link.href}
                  onClick={(e) => {
                    // Allow navigation to tickets page
                  }}
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <>
                <Link
                  href="/profile"
                  className="hidden lg:inline-flex items-center justify-center px-5 py-2.5 rounded-full bg-white/80 dark:bg-white/5 border border-black/5 dark:border-white/10 text-xs font-bold uppercase tracking-widest text-black dark:text-white hover:bg-white dark:hover:bg-white/10 transition-all font-heading shadow-sm backdrop-blur-md"
                >
                  Profile
                </Link>
              </>
            ...
            <button
              type="button"
              className="relative flex h-11 w-11 flex-col items-center justify-center gap-1.5 rounded-full bg-white/80 dark:bg-white/5 border border-black/5 dark:border-white/10 lg:hidden shadow-sm backdrop-blur-md"
              onClick={toggleMenu}
