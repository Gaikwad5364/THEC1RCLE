...
export default function RitualBackground() {
    return (
        <div className="fixed inset-0 -z-10 overflow-hidden bg-zinc-50 dark:bg-black pointer-events-none">
            ...
            <div className="absolute inset-0">
                {[...Array(20)].map((_, i) => (
                    <motion.div
                        ...
                        className="absolute h-1 w-1 bg-black/20 dark:bg-white rounded-full blur-[1px]"
                    />
                ))}
            </div>
            ...
            {/* Bottom Vignette */}
            <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-zinc-100/80 dark:from-black via-transparent to-transparent opacity-80" />
        </div>
    );
}
