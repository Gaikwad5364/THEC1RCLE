                ...
                {GENDER_OPTIONS.map((option) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <Icon className={`w-4 h-4 ${isSelected ? "text-orange" : "text-black/40 dark:text-white/40"}`} />
                            <span className={`text-[11px] font-black uppercase tracking-[0.2em] ${isSelected ? "text-black dark:text-white" : "text-black/40 dark:text-white/40"}`}>
                                {option.label}
                            </span>
                        </motion.button>
                    );
