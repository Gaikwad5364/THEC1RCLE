    ...
    return (
        <div className="flex flex-col items-center justify-center text-center space-y-8 max-w-[400px]">
            ...
            >
                ...
                <p className="text-[10px] font-bold text-black/40 dark:text-white/40 uppercase tracking-[0.4em]">
            ...
            >
                <Link
                    href="/explore"
                    className="group relative h-16 flex items-center justify-center rounded-3xl bg-black dark:bg-white text-white dark:text-black font-black uppercase tracking-[0.5em] text-xs transition-all hover:scale-[1.02] active:scale-95"
                >
                ...
                <Link
                    href="/tickets"
                    className="group h-16 flex items-center justify-center rounded-3xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 text-black/60 dark:text-white/60 font-black uppercase tracking-[0.5em] text-xs transition-all hover:bg-black/10 dark:hover:bg-white/10 hover:text-black dark:hover:text-white"
                >
