        ...
        <div className="flex flex-col items-center gap-2">
            <button
                ...
                className={clsx(
                    ...
                    seconds > 0 || disabled ? "text-black/20 dark:text-white/20 cursor-not-allowed" : "text-orange hover:opacity-80 active:scale-95"
                )}
            >
            ...
            {resendCount >= 3 && seconds > 0 && (
                <p className="text-[9px] font-bold text-black/30 dark:text-white/30 uppercase tracking-widest text-center max-w-[200px]">
