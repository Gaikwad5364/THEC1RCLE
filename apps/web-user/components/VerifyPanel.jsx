    ...
    return (
        <div className="space-y-6 w-full max-w-[500px]">
            ...
            <button
                ...
                className={clsx(
                    "group relative w-full h-16 flex items-center justify-center rounded-full bg-black dark:bg-white text-white dark:text-black font-black uppercase tracking-[0.5em] text-xs transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 overflow-hidden shadow-[0_20px_40px_rgba(30,30,30,0.15)] dark:shadow-[0_20px_40px_rgba(255,165,0,0.15)]",
                    allVerified ? "bg-black dark:bg-white" : "bg-black/5 dark:bg-white/5 text-black/20 dark:text-white/20 border border-black/10 dark:border-white/10"
                )}
            >
                {loading ? (
    ...
    return (
        <motion.div
            ...
            className={clsx(
                ...
                verified ? "bg-orange/[0.02] border-orange/30" : "bg-black/[0.03] dark:bg-white/[0.03] border-black/10 dark:border-white/10"
            )}
        >
            <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-4">
                    <div className={clsx(
                        ...
                        verified ? "bg-orange text-white" : "bg-black/5 dark:bg-white/5 text-black/40 dark:text-white/40"
                    )}>
                        {icon}
                    </div>
                    <div>
                        <p className="text-[9px] font-black uppercase tracking-[0.3em] text-black/40 dark:text-white/40">{title}</p>
                        <p className="text-xs font-bold text-black dark:text-white tracking-widest truncate max-w-[180px]">{identifier}</p>
                    </div>
                </div>
