...
export default function LoginPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-zinc-50 dark:bg-black" />}>
            <div className="relative h-screen min-h-[600px] bg-zinc-50 dark:bg-black overflow-hidden flex flex-col md:flex-row selection:bg-orange/30 selection:text-black dark:selection:text-white">
                <RitualBackground />
                <LoginForm />
            </div>
        </Suspense>
...
function LoginForm() {
    ...
    return (
        <div className="flex flex-col md:flex-row w-full h-full min-h-screen">
            ...
            <div className="hidden md:flex md:w-1/2 lg:w-3/5 h-full relative overflow-hidden bg-zinc-100 dark:bg-[#050505] items-center justify-center p-20 flex-col">
                ...
                >
                    ...
                    <h2 className="text-7xl font-black uppercase tracking-tighter leading-[0.8] text-black dark:text-white">
                        Enter the <br /> <span className="text-orange">Sanctuary.</span>
                    </h2>
                    <p className="text-sm font-medium text-black/40 dark:text-white/40 uppercase tracking-[0.4em] leading-relaxed max-w-md">
                ...
                <div className="absolute bottom-20 left-20 flex gap-4">
                    {[1, 2, 3].map(i => (
                        <div key={i} className="h-0.5 w-12 bg-black/10 dark:bg-white/10 overflow-hidden">
                            <motion.div
            ...
            <div className="flex-1 flex flex-col justify-center items-center px-4 md:px-12 relative z-10 w-full h-full min-h-screen bg-white/60 dark:bg-black/50 md:bg-transparent backdrop-blur-xl md:backdrop-blur-none">
                {/* Fixed Header */}
                <header className="absolute top-8 left-8 right-8 flex justify-between items-center z-50">
                    <button
                        onClick={prevStep}
                        className="h-10 w-10 flex items-center justify-center rounded-full border border-black/5 dark:border-white/5 bg-black/[0.02] dark:bg-white/[0.02] backdrop-blur-xl hover:border-orange/50 transition-colors group"
                    >
                        <ArrowLeft className="h-5 w-5 text-black/40 dark:text-white/40 group-hover:text-orange transition-colors" />
                    </button>
                    <Link href="/" className="md:hidden flex items-center gap-3">
                        ...
                        <span className="font-heading text-[10px] font-black uppercase tracking-widest text-black dark:text-white">THE C1RCLE</span>
                    </Link>
                </header>
                ...
                <div className="w-full max-w-[420px] py-12">
                    {step < 5 && (
                        <div className="mb-10 text-center md:text-left">
                            ...
                            >
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-[0.8] text-black dark:text-white">
                                    {mode === "login" ? (
                        ...
                        <AnimatePresence mode="wait">
                            {step < 5 ? (
                                <motion.div
                                    ...
                                    className="relative glass-panel bg-white/60 dark:bg-white/[0.02] border border-black/5 dark:border-white/10 backdrop-blur-2xl rounded-[40px] p-8 md:p-10 shadow-2xl overflow-hidden"
                                >
                                    ...
                                    <form onSubmit={(e) => { e.preventDefault(); nextStep(); }} className="space-y-8">
                                        <AnimatePresence mode="wait">
                                            ...
                                            >
                                                {step === 1 && (
                                                    <div className="space-y-6">
                                                        <div className="group relative">
                                                            ...
                                                            <label className="text-[10px] font-black uppercase tracking-[0.3em] text-black/40 dark:text-white/40 mb-2 block">Electronic Mail</label>
                                                            <input
                                                                type="email"
                                                                autoFocus
                                                                required
                                                                ...
                                                                className="w-full bg-transparent border-b border-black/10 dark:border-white/10 py-4 text-sm font-bold tracking-widest text-black dark:text-white placeholder:text-black/20 dark:placeholder:text-white/10 focus:outline-none"
                                                            />
                                                        </div>
                                                        ...
                                                        <button
                                                            ...
                                                            disabled={submitting}
                                                            className="w-full group flex items-center justify-center gap-3 py-4 bg-black/[0.03] dark:bg-white/[0.03] rounded-2xl border border-black/10 dark:border-white/10 text-[10px] font-black uppercase tracking-[0.3em] text-black/40 dark:text-white/30 hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black transition-all"
                                                        >
                                                ...
                                                {step === 2 && (
                                                    <div className="group relative">
                                                        <div className="absolute left-0 bottom-0 h-0.5 w-0 bg-orange group-focus-within:w-full transition-all duration-700" />
                                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-black/40 dark:text-white/40 mb-2 block">Security Passphrase</label>
                                                        <input
                                                            type="password"
                                                            autoFocus
                                                            required
                                                ...
                                                {step === 3 && (
                                                    <div className="group relative">
                                                        <div className="absolute left-0 bottom-0 h-0.5 w-0 bg-orange group-focus-within:w-full transition-all duration-700" />
                                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-black/40 dark:text-white/40 mb-2 block">Legal Identity (Alias)</label>
                                                        <input
                                                            type="text"
                                                            autoFocus
                                                            required
                                                ...
                                                {step === 4 && (
                                                    <div className="space-y-4">
                                                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-black/40 dark:text-white/40 block">Select Essence</label>
                                                        <GenderSelector
                                                            value={form.gender}
                                        ...
                                        <button
                                            type="submit"
                                            disabled={submitting}
                                            className="group relative w-full h-16 flex items-center justify-center rounded-full bg-black dark:bg-white text-white dark:text-black font-black uppercase tracking-[0.5em] text-xs transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 overflow-hidden shadow-[0_20px_40px_rgba(30,30,30,0.15)] dark:shadow-[0_20px_40px_rgba(255,165,0,0.15)]"
                                        >
                                            ...
                                            <span className="relative z-10 flex items-center gap-3 group-hover:text-white dark:group-hover:text-black transition-colors">
                                                {submitting ? (
                                    ...
                                    <div className="mt-8 flex justify-center md:justify-start gap-3">
                                        {Array.from({ length: totalSteps }).map((_, i) => (
                                            <div
                                                key={i}
                                                className={`h-0.5 transition-all duration-500 rounded-full ${i + 1 === step ? "w-8 bg-orange shadow-[0_0_10px_rgba(255,165,0,0.5)]" : "w-2 bg-black/10 dark:bg-white/10"}`}
                                            />
                                        ))}
                                    </div>
                                </motion.div>
                    ...
                    {step < 5 && (
                        <div className="mt-12 text-center md:text-left">
                            <button
                                onClick={toggleMode}
                                className="text-[11px] font-black uppercase tracking-[0.4em] text-black/70 dark:text-white/70 hover:text-orange transition-colors"
                            >
