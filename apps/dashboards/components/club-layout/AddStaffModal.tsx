...
import { StaffRole, ROLE_PERMISSIONS } from "@/lib/rbac/types";
...
const ROLE_OPTIONS: { value: StaffRole; label: string; description: string }[] = [
    ...
    { value: "CLUB_MANAGER", label: "Club Manager", description: "Can manage events, tables, and operations. No staff management." },
...
export function AddStaffModal({ isOpen, onClose, onAdd }: AddStaffModalProps) {
    ...
    const [selectedRole, setSelectedRole] = useState<StaffRole>("FLOOR_MANAGER");
